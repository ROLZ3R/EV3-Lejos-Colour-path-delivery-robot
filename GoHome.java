...
public class GoHome implements Behavior 
{
	...
	public void action() 
	{
		...
		// Setting the value of the Destination boolean variable to be false, since the robot is no longer at the destination to drop off parcels
		destinationDetection.setDestination(false);

		// Making the robot follow the green line until it reaches the purple line ( green no longer detected at that point )
