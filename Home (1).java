...
public class Home implements Behavior 
{
	...
	public void action() 
	{
		...
		// If the robot is at the designated parcel pick up point then the program lets the user put a parcel in, after which it finds the correct line to follow to the drop off point
		...
		// Else if the robot has just finished returning home from the parcel destination via the green line, it moves forward until it is at the designated parcel drop-off point, after which it rotates 180 degrees
